...
#wordslist = wordslist.downcase	# Makes every word start with lowercase (easier for sorting)
...
words.each do |word,occ|	# Itarates through our array and prints the words and number of occurences for each one of them
  puts word + ',' + occ.to_s
end
