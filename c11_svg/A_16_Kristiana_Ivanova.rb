...
def rect2 x, y, width, height
	'<rect width="'+width.to_s+'" height="'+height.to_s+'" x="'+x.to_s+'" y="'+y.to_s+'" style="fill:green;stroke-width:3;stroke:rgb(0,0,0)"/>'
end
